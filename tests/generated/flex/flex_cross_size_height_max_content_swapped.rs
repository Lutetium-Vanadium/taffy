...
fn flex_cross_size_height_max_content_swapped__border_box() {
    ...
    let Layout { size, location, .. } = layout;
    assert_eq!(size.width, 61f32, "width of node {:?}. Expected {}. Actual {}", node0, 61f32, size.width);
    ...
    assert_eq!(location.x, 61f32, "x of node {:?}. Expected {}. Actual {}", node1, 61f32, location.x);
    assert_eq!(location.y, 0f32, "y of node {:?}. Expected {}. Actual {}", node1, 0f32, location.y);
}

#[test]
#[allow(non_snake_case)]
fn flex_cross_size_height_max_content_swapped__content_box() {
    #[allow(unused_imports)]
    use taffy::{prelude::*, Layout};
    let mut taffy = crate::new_test_tree();
    let node00 = taffy
