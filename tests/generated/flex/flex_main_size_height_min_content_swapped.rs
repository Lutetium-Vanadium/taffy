...
fn flex_main_size_height_min_content_swapped__border_box() {
    ...
    assert_eq!(location.y, 30f32, "y of node {:?}. Expected {}. Actual {}", node03, 30f32, location.y);
    ...
    assert_eq!(location.x, 0f32, "x of node {:?}. Expected {}. Actual {}", node04, 0f32, location.x);
    ...
    assert_eq!(location.y, 60f32, "y of node {:?}. Expected {}. Actual {}", node06, 60f32, location.y);
...
#[test]
#[allow(non_snake_case)]
fn flex_main_size_height_min_content_swapped__content_box() {
    #[allow(unused_imports)]
    use taffy::{prelude::*, Layout};
    let mut taffy = crate::new_test_tree();
    let node00 = taffy
