...
fn flex_cross_size_min_width_max_content__border_box() {
    ...
    let node0 = taffy
        .new_with_children(
            taffy::style::Style {
                ...
                min_size: taffy::geometry::Size { width: taffy::style::Dimension::MAX_CONTENT, height: auto() },
                ..Default::default()
            },
    ...
    assert_eq!(location.x, 50f32, "x of node {:?}. Expected {}. Actual {}", node05, 50f32, location.x);
    assert_eq!(location.y, 0f32, "y of node {:?}. Expected {}. Actual {}", node05, 0f32, location.y);
    ...
    assert_eq!(location.x, 60f32, "x of node {:?}. Expected {}. Actual {}", node06, 60f32, location.x);
    assert_eq!(location.y, 0f32, "y of node {:?}. Expected {}. Actual {}", node06, 0f32, location.y);
...
#[test]
#[allow(non_snake_case)]
fn flex_cross_size_min_width_max_content__content_box() {
    #[allow(unused_imports)]
    use taffy::{prelude::*, Layout};
    let mut taffy = crate::new_test_tree();
    let node00 = taffy
