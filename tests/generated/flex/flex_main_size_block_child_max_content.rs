...
fn flex_main_size_block_child_max_content__border_box() {
    ...
    let node0 = taffy
        .new_with_children(
            taffy::style::Style {
                ...
                size: taffy::geometry::Size { width: taffy::style::Dimension::MAX_CONTENT, height: auto() },
                ..Default::default()
            },
            &[node00],
        )
    ...
    assert_eq!(location.x, 50f32, "x of node {:?}. Expected {}. Actual {}", node005, 50f32, location.x);
    assert_eq!(location.y, 0f32, "y of node {:?}. Expected {}. Actual {}", node005, 0f32, location.y);
    ...
    assert_eq!(location.x, 60f32, "x of node {:?}. Expected {}. Actual {}", node006, 60f32, location.x);
    assert_eq!(location.y, 0f32, "y of node {:?}. Expected {}. Actual {}", node006, 0f32, location.y);
    ...
    assert_eq!(location.x, 70f32, "x of node {:?}. Expected {}. Actual {}", node1, 70f32, location.x);
    assert_eq!(location.y, 0f32, "y of node {:?}. Expected {}. Actual {}", node1, 0f32, location.y);
}

#[test]
#[allow(non_snake_case)]
fn flex_main_size_block_child_max_content__content_box() {
    #[allow(unused_imports)]
    use taffy::{prelude::*, Layout};
    let mut taffy = crate::new_test_tree();
    let node000 = taffy
