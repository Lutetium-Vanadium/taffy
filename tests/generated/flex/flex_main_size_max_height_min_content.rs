...
fn flex_main_size_max_height_min_content__border_box() {
    ...
    let node0 = taffy
        .new_with_children(
            taffy::style::Style {
                ...
                max_size: taffy::geometry::Size { width: auto(), height: taffy::style::Dimension::MIN_CONTENT },
                ..Default::default()
            },
...
#[test]
#[allow(non_snake_case)]
fn flex_main_size_max_height_min_content__content_box() {
    #[allow(unused_imports)]
    use taffy::{prelude::*, Layout};
    let mut taffy = crate::new_test_tree();
    let node00 = taffy
