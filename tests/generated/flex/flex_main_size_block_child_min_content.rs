...
fn flex_main_size_block_child_min_content__border_box() {
    ...
    let node0 = taffy
        .new_with_children(
            taffy::style::Style {
                ...
                size: taffy::geometry::Size { width: taffy::style::Dimension::MIN_CONTENT, height: auto() },
                ..Default::default()
            },
            &[node00],
        )
        .unwrap();
    let node1 = taffy
        .new_leaf(taffy::style::Style { flex_basis: taffy::style::Dimension::from_length(10f32), ..Default::default() })
        .unwrap();
    let node = taffy
        .new_with_children(
            taffy::style::Style {
    ...
    assert_eq!(size.height, 70f32, "height of node {:?}. Expected {}. Actual {}", node, 70f32, size.height);
    ...
    assert_eq!(location.y, 10f32, "y of node {:?}. Expected {}. Actual {}", node001, 10f32, location.y);
    ...
    assert_eq!(location.x, 0f32, "x of node {:?}. Expected {}. Actual {}", node002, 0f32, location.x);
    assert_eq!(location.y, 20f32, "y of node {:?}. Expected {}. Actual {}", node002, 20f32, location.y);
    ...
    assert_eq!(location.x, 0f32, "x of node {:?}. Expected {}. Actual {}", node003, 0f32, location.x);
    assert_eq!(location.y, 30f32, "y of node {:?}. Expected {}. Actual {}", node003, 30f32, location.y);
    ...
    assert_eq!(location.x, 0f32, "x of node {:?}. Expected {}. Actual {}", node004, 0f32, location.x);
    assert_eq!(location.y, 40f32, "y of node {:?}. Expected {}. Actual {}", node004, 40f32, location.y);
    ...
    assert_eq!(location.y, 50f32, "y of node {:?}. Expected {}. Actual {}", node005, 50f32, location.y);
    ...
    assert_eq!(location.x, 0f32, "x of node {:?}. Expected {}. Actual {}", node006, 0f32, location.x);
    assert_eq!(location.y, 60f32, "y of node {:?}. Expected {}. Actual {}", node006, 60f32, location.y);
    let layout = taffy.layout(node1).unwrap();
    let Layout { size, location, .. } = layout;
    assert_eq!(size.width, 10f32, "width of node {:?}. Expected {}. Actual {}", node1, 10f32, size.width);
    assert_eq!(size.height, 70f32, "height of node {:?}. Expected {}. Actual {}", node1, 70f32, size.height);
...
#[test]
#[allow(non_snake_case)]
fn flex_main_size_block_child_min_content__content_box() {
    #[allow(unused_imports)]
    use taffy::{prelude::*, Layout};
    let mut taffy = crate::new_test_tree();
    let node000 = taffy
