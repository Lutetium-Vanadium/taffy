...
fn block_max_height_max_content__border_box() {
    ...
    let node0 = taffy
        .new_with_children(
            taffy::style::Style {
                ...
                max_size: taffy::geometry::Size { width: auto(), height: taffy::style::Dimension::MAX_CONTENT },
                ..Default::default()
            },
            &[node00],
        )
...
#[test]
#[allow(non_snake_case)]
fn block_max_height_max_content__content_box() {
    #[allow(unused_imports)]
    use taffy::{prelude::*, Layout};
    let mut taffy = crate::new_test_tree();
    let node000 = taffy
