...
fn block_min_height_min_content__border_box() {
    ...
    let node0 = taffy
        .new_with_children(
            taffy::style::Style {
                ...
                min_size: taffy::geometry::Size { width: auto(), height: taffy::style::Dimension::MIN_CONTENT },
                ..Default::default()
            },
            &[node00],
        )
...
#[test]
#[allow(non_snake_case)]
fn block_min_height_min_content__content_box() {
    #[allow(unused_imports)]
    use taffy::{prelude::*, Layout};
    let mut taffy = crate::new_test_tree();
    let node000 = taffy
